...
def remove_extra_chains(pdbfixer_obj):
    """
    calls some openMM functions
    uses comprehension since the pdb fixer object is an interator
    """
...
#turn the following into function during refactoring
...
for pdb_name in directory_content:
    ...
    number_missing_atoms = len(fix_pdb.missingAtoms)
    missing_atom_dict[pdb_name] = number_missing_atoms
